...
class DungeonViewer(object):
    ...
    def show_phase_round(self):
        round_status = [StatusType.round_init, StatusType.round_start, StatusType.round_next_turn,
                        StatusType.round_challenge, StatusType.round_end]
    ...
    def show_phase_challenge(self):
        challenge_status = [StatusType.challenge_init, StatusType.challenge_start, StatusType.challenge_next_battle,
                            StatusType.challenge_end]
    ...
    def show_phase_battle(self):
        battle_status = [StatusType.battle_init, StatusType.battle_start, StatusType.battle_execute,
                         StatusType.battle_end]
